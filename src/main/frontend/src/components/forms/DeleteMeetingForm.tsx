...
import {useDeleteMeetingMutation} from "../../services";
...
export function DeleteMeetingForm({ onCancel, afterSubmit } : Props) {
    const meeting: Meeting = useSelector((state: RootState) => state.meetings.meeting)
    const [deleteMeeting, {isLoading, isError, isSuccess, error}] = useDeleteMeetingMutation();
